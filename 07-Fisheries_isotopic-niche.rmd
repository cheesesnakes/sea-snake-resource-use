...
SEA.B_snakes.fi.df%>%
  ...
  geom_boxplot(alpha = 0.3, width = 0.25, position = position_dodge(preserve = "single"))+
  scale_y_continuous(limits = c(0,5), name = "Standard Ellispes Area", guide = guide_axis(n.dodge = 1))+
