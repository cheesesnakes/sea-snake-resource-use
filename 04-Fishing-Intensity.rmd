...
Each fishing trip is assigned to a cell in the sampling grid. Total fishing effort in each grid cell is then calculated to quatify local fishing intensity.
