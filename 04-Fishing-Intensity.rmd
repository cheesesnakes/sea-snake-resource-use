...
Each fishing trip is assigned to a cell in the sampling grid of **`r ncell(ext)` cells** with **`r nrow(ext)` rows** and **`r ncol(ext)` columns**. Total fishing effort in each grid cell is then calculated to quatify local fishing intensity.
